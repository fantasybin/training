...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Calendar = function (_React$Component) {
	    ...
	    function Calendar(props) {
	        ...
	        _this.state = {
	            show: _this.props.show, //控制日历组件的显示和隐藏
	            year: _this.props.year || _this.today().year,
	            month: _this.props.month || _this.today().month,
	            monthDays: new Date(_this.props.year, _this.props.month, 0).getDate() || _this.today().monthDays,
	            day: _this.props.day || _this.today().day
	        };
	        return _this;
	    }
	    ...
	    _createClass(Calendar, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var that = this;
	            var calendarDom = this.refs.calendar;
	            var calendarYear = calendarDom.children[1];
	            var calendarMonth = calendarDom.children[2];
	            var calendarDay = calendarDom.children[3];
	        ...
	        key: "swipe",
	        value: function swipe(element, fn) {
	        ...
	        key: "changeDate",
	        value: function changeDate(dateType, direction) {
	            var maxYear = 2099; //年数上限
	            var minYear = 1900; //年数下限
	            var maxMonth = 12;
	            var minMonth = 1;
	            var maxDay = this.state.monthDays;
	            var minDay = 1;
	        ...
	        key: "confirmOrCancel",
	        value: function confirmOrCancel(flag, data) {
	            var confirm = this.props.confirmCallback;
	            var cancel = this.props.cancelCallback;
	        ...
	        value: function render() {
	            ...
	            var yesterday = day - 1 < 1 ? monthDays : day - 1;
	            var selectedData = year + "-" + month + "-" + day;
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { ref: "calendar", style: styles.simpleCalendar },
	                    _react2.default.createElement(
	                        "div",
	                        { style: styles.calendarTitle },
	                        _react2.default.createElement(
	                            "span",
	                            { onClick: this.confirmOrCancel.bind(this, "cancel"),
	                                style: styles.cancel },
	                            "\u53D6\u6D88"
	                        ),
	                        _react2.default.createElement(
	                            "span",
	                            { onClick: this.confirmOrCancel.bind(this, "confirm", selectedData),
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "p",
	                            { style: styles.p },
	                            month + 1 > 12 ? month - 12 + 1 : month + 1,
	                            "\u6708"
	                        ),
	                        _react2.default.createElement(
	                            "p",
	                            { style: styles.p },
	                            month + 2 > 12 ? month - 12 + 2 : month + 2,
	                            "\u6708"
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "p",
	                            { style: styles.p },
	                            yesterday - 1 < 1 ? monthDays : yesterday - 1,
	                            "\u65E5"
	                        ),
	                        _react2.default.createElement(
	                            "p",
	                        ...
	                        _react2.default.createElement(
	                            "p",
	                            { style: styles.p },
	                            day + 1 > monthDays ? day - monthDays + 1 : day + 1,
	                            "\u65E5"
	                        ),
	                        _react2.default.createElement(
	                            "p",
	                            { style: styles.p },
	                            day + 2 > monthDays ? day - monthDays + 2 : day + 2,
	                            "\u65E5"
	                        )
	                    )
	                )
	...
	_react2.default.render(_react2.default.createElement(Calendar, null), document.getElementById("app"));
