...
import './dialog.less';//引入样式文件 此处省略CSS Mouldes 或者 style in js的css模块化方案讨论
...
class Dialog extends Component {
    ...
    render(){
        ...
        <div className="box-container">
            {open &&
            <div className="ucar-dialog">
                <div className="ud-dialog">
                    <div className="ud-dialog-title">
                        {title}
                    </div>
                    <div className="ud-dialog-content">
                        {children}
                    </div>
                    <div className="ud-dialog-foot">
                        {actions}
                    </div>
                </div>
            </div>
