...
class CommentInputContainer extends Component {
  ...
  constructor () {
    super()
    this.state = { username: '' }
    console.info('containers.commentinput.constructor');
  }

  componentWillMount () {
    console.info('containers.commentinput.componentWillMount');
  ...
  _loadUsername () {
    ...
    if (username) {
      console.info('containers.commentinput.setstate');
  ...
  render () {
    console.info('containers.commentinput.render');
